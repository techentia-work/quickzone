...
const inputVariants = {
  variant: {
    ...
    outline:
      "border-2 border-green-500 focus:ring-green-500 focus:border-green-600",
      ...
      <div className={cn("flex flex-col w-full gap-2", classes, className)}>
        {label && (
          ...
          >
            <div className="relative">
              ...
              {markAsRequired && (
                <span className="text-[22px] text-[#EB001B] absolute -top-1.5 -right-2.5">
                  *
                </span>
              )}
            </div>
        ...
        <div className="relative w-full">
          <input
            ...
            onChange={onChange}
            className={cn(
              "w-full text-base leading-5 px-4 py-3 rounded-xl border focus:outline-none focus:ring-2 transition-all",
        ...
        {errLabel && (
          <p
            className={cn(
              ...
              hasError
                ? "text-[#ff3131] font-normal"
                : hasSuccess
                ? "text-[#1bcc00] font-light"
                : ""
            )}
          >
            {error || success}
