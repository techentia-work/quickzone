...
export function FeaturedProductBottom() {
      ...
      <div className="mx-auto px-3 md:px-6 lg:px-8 space-y-5">
        {filteredFeatured.map((feature: any) => {
          ...
          return (
            <div
              key={feature._id}
              className="relative overflow-hidden rounded-xl shadow-sm transition-shadow duration-300 min-h-[300px] flex flex-col md:flex-row"
            >
              {/* Banner Section */}
