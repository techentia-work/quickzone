...
class CacheInterceptor extends Interceptor {
  ...
  final Duration staleWhileRevalidate = const Duration(minutes: 15);

  final List<String> noCacheEndpoints = ['/auth/me', '/user/profile', '/wishlist', '/cart'];
  ...
  Duration _getCacheDuration(RequestOptions options) {
    ...
    if (path.contains('/category')) return const Duration(minutes: 10);
