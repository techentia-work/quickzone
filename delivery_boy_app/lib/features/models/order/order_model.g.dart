...
OrderType _$OrderTypeFromJson(Map<String, dynamic> json) => OrderType(
  ...
  userId: UserInfoType.fromJson(json['userId'] as Map<String, dynamic>),
  ...
  handlingCharge: (json['handlingCharge'] as num?)?.toDouble(),
  promoUsed: (json['promoUsed'] as num?)?.toDouble(),
  walletUsed: (json['walletUsed'] as num?)?.toDouble(),
  totalAmount: (json['totalAmount'] as num).toDouble(),
  shippingAddress: ShippingAddressType.fromJson(
    json['shippingAddress'] as Map<String, dynamic>,
  ),
  billingAddress: ShippingAddressType.fromJson(
  ...
  appliedPromo: json['appliedPromo'] == null
      ? null
      : OrderPromo.fromJson(json['appliedPromo'] as Map<String, dynamic>),
