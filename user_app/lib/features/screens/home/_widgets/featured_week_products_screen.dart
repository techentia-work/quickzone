...
import 'package:Quickzon/features/providers/featured/featured_week_products_provider.dart';
...
class FeaturedWeekProductsScreen extends ConsumerStatefulWidget {
  final FeaturedWeekBrand featuredBrand;

  const FeaturedWeekProductsScreen({
    super.key,
    required this.featuredBrand,
  });

  @override
  ConsumerState<FeaturedWeekProductsScreen> createState() =>
      _FeaturedWeekProductsScreenState();
}

class _FeaturedWeekProductsScreenState
    extends ConsumerState<FeaturedWeekProductsScreen> {
  ...
  Widget build(BuildContext context) {
    final productsAsync = ref.watch(
      featuredWeekProductsProvider(widget.featuredBrand.name),
    );
        ...
        slivers: [
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: widget.featuredBrand.banner != null
                  ? CachedNetworkImage(
                imageUrl: widget.featuredBrand.banner!,
                fit: BoxFit.cover,
