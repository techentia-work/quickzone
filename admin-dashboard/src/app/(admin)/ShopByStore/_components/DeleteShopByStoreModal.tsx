...
import { AlertTriangle, Trash2, X, Store } from "lucide-react";
import Image from "next/image";
import { ShopByStoreType } from "@/lib/types/shopByStore/shopByStore.types";

interface DeleteShopByStoreModalProps {
  isOpen: boolean;
  closeModal: () => void;
  item: ShopByStoreType | null;
  onConfirm: (id: string) => Promise<void>;
  isLoading?: boolean;
}

export function DeleteShopByStoreModal({
  isOpen,
  closeModal,
  item: selectedItem,
  onConfirm,
  isLoading = false,
}: DeleteShopByStoreModalProps) {
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 mt-1">
                  This will permanently remove the store from the Shop By Store
                  section on homepage/app. The original Store data will not be
                  deleted.
                </p>
              </div>
            </div>
