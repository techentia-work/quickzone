...
import { Eye, Edit, Trash2, Layout, CheckCircle } from "lucide-react";
import { FilterSchema } from "@/lib/types";

export const sliderEntitySchema: FilterSchema = {
  ...
  statsCards: [
    {
      key: "counts.totalSliders",
      title: "Total Sliders",
      icon: "Layout",
      color: "bg-blue-500",
    },
    {
      key: "counts.activeSliders",
      title: "Active Sliders",
      icon: "CheckCircle",
      color: "bg-green-500",
    },
    {
      key: "counts.deletedSliders",
      title: "Deleted Sliders",
      icon: "Trash2",
      color: "bg-red-500",
    },
  ],
